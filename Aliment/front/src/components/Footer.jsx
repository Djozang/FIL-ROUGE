    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">NutriSanté</h3>
            <p className="text-gray-400 mb-4">
              Votre partenaire pour une alimentation adaptée à vos besoins de santé.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-400">
                ...
                <span>contact@nutrisante.com</span>
              </li>
              <li className="flex items-center text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} NutriSanté. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
